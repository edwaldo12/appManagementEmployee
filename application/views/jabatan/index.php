...
<?php if ($this->session->flashdata('tambah_jabatan')) { ?>
	<?php unset($_SESSION['storeJabatan']) ?>
	<script>
		alert('Tambah Jabatan berhasil!');
	</script>
<?php } ?>

<?php if ($this->session->flashdata('update_jabatan')) { ?>
...
<?php if ($this->session->flashdata('hapus_jabatan')) { ?>
